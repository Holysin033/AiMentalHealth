<template>
  <div>
    ...
    <el-table :data="tableData" stripe style="width: 100%;margin-top: 25px" highlight-current-row border
...
const formItem = ref([
  ...
  },
  {
    ...
    label: "状态",
    placeholder: "请选择状态",
    options: [{ label: '草稿', value: '0' }, { label: '已发布', value: '1' }, { label: '已下线', value: '2' }],
  },
]);
